import { c as createCommonjsModule, _ as _extends$1, u as useEasybase } from './index-775190d4.js';
...
const DefaultSignIn = lazy(() => import('./SignIn-e3dbf321.js'));
const DefaultSignUp = lazy(() => import('./SignUp-a3e46665.js'));
const DefaultForgotPassword = lazy(() => import('./ForgotPassword-b6106b69.js'));
function Auth ({
  theme,
  customStyles,
  children,
  ...
  if (isUserSignedIn()) {
    ...
    return React__default.createElement(Fe, {
      theme: themeVal
...
export { Auth$1 as A, styled as s, toast as t };
//# sourceMappingURL=Auth-25393280.js.map
